...
#clasesObtenidas = libsvm.test(HISTOGRAMS_FILE, model_file)
print libsvm.test(HISTOGRAMS_FILE, model_file)
#print clasesObtenidas

#print len(clasesObtenidas)
#uniques = list(set(clasesObtenidas))
#frecs=[]
#for oneClass in uniques:
#  cont = 0.
#  for clase in clasesObtenidas:
#      if clase == oneClass:
#        cont += 1
#  frecs.append(cont/len(clasesObtenidas))
