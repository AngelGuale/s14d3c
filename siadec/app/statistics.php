		<div class="col-md-4">
			...
			<div class="col-md-12 stats-info widget-shadow">
				<div class="stats-title">
					<h4 class="title">Detected diseases</h4>
				</div>
				<div class="stats-body">
					<ul class="list-unstyled">
						<li>WSSV <span class="pull-right">50%</span>  
							<div class="progress progress-striped active progress-right">
								<div style="width:50%;" class="bar yellow"></div>
							</div>
						</li>
						<li>Vibriosis <span class="pull-right">50%</span>  
							<div class="progress progress-striped active progress-right">
								<div style="width:50%;" class="bar blue"></div>
							</div>
						</li>
					</ul>
				</div>
